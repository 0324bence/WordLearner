...
import hu.delibence.wordlearner.ui.routes.ExportPDF
...
import hu.delibence.wordlearner.ui.routes.ImportText
                ...
                learnerViewModel.routes.forEach { entry ->
                    ...
                    navigation(startDestination = "lists", route = "importexport") {
                        ...
                        composable("importtext") {
                            ImportText(navController = navController)
                        }
                        composable("exportpdf") {
                            ExportPDF(navController = navController)
                        }
                    }
